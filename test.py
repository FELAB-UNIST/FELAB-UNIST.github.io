# publications.js 전체 수정 - GitHub, Cite 버튼, Google Scholar 링크 추가

publications_js = '''// Publications Manager Module
const PublicationsManager = {
    ...
    labMembers: [
        ...
        'Yoontae Hwang', 'Joohwan Hong', 'Hyeongwoo Kong', 'Suhwan Park'
    ],
...
with open('publications.js', 'w', encoding='utf-8') as f:
    f.write(publications_js)

print("publications.js 생성 완료!")